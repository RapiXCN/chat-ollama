...
import { OPENAI_EMBEDDING_MODELS, GEMINI_EMBEDDING_MODELS, TONGYI_EMBEDDING_MODELS } from '~/config/index'
...
const embeddingList = computed(() => {
  ...
  const getEmbeddingFromKnowledgeBaseList = props.embeddings.filter(e => ![...OPENAI_EMBEDDING_MODELS, ...GEMINI_EMBEDDING_MODELS, ...TONGYI_EMBEDDING_MODELS].includes(e))
  ...
  return [
    ...
    generateEmbeddingData('Tongyi', TONGYI_EMBEDDING_MODELS, 'group'),
  ].flatMap(items => {
